...
<style lang="scss">
  footer {
    @apply mt-12 text-gray-300 border-t border-white/5 relative;

    .footer-logo {
      @apply absolute -top-8 left-0 w-full flex justify-center;

      img {
        @apply max-h-32 drop-shadow-lg;
      }
    }
