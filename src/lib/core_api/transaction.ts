...
export class CoreTransactionAPI {
	static async queryTransactions(params: RouteParams | null = null, query_param: URLSearchParams): Promise<TransactionI[]> {
	...
	static async countTransactions(params: RouteParams | null = null, query_param: URLSearchParams): Promise<number> {
	...
	static async patchTransaction(params: RouteParams | null = null,
																...
																patchObj: Partial<TransactionI>): Promise<TransactionI> {
	...
	static async groupByTransactions(params: RouteParams | null = null, query_param: URLSearchParams): Promise<[]> {
