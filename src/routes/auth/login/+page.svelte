...
<svelte:head>
  <title>Aanmelden | IngeniumUA</title>
...
<main class="ingenium-container h-full text-center flex flex-1 flex-col justify-center items-center">
  {#if isFailed}
    ...
    <p>We konden de inlogserver niet contacteren. Probeer het opnieuw of contacteer ons voor hulp</p>
  {:else}
    ...
    <h1 class="white-section-title white-section-title-large">Aanmelden</h1>
    <p>Je wordt automatisch doorverwezen, even geduld...</p>
  {/if}
</main>