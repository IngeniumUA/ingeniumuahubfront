...
<main class="bg-gray-100 pb-40">
	...
	<div class="p-6 min-h-36
		...
		<div class="flex flex-row gap-8 items-center justify-center">
			...
			{#if (hasRole("staff"))}
				<h1 class="text-3xl text-center underline text-white"><a href="/orders/manage">Staff</a></h1>
			{/if}
		</div>
	</div>
			...
			{#each groupedProducts as groupedProduct, index}
				<div class="product-card">
					<div class="product-card-image">
						<img src={item.derived_type.display.image_square} alt="Item Image" loading="lazy" width="1024" height="1024" aria-hidden="true" />
					</div>
