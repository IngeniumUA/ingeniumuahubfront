<script lang="ts">
  ...
  async function copySharelink() {
    ...
    let baseLink = data.event.derived_type.display.follow_through_link
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <section class="col-span-1 md:col-span-2">
      ...
      <div class="flex flex-row items-center justify-end mb-4">
        ...
        {#if ((data.event.item.item_metadata.social_media_configuration?.facebook_url ?? null) !== null)}
          <a href={data.event.item.item_metadata.social_media_configuration?.facebook_url ?? null} aria-label="facebook">
        ...
        {#if ((data.event.item.item_metadata.social_media_configuration?.linkedin_url ?? null) !== null)}
          <a href={data.event.item.item_metadata.social_media_configuration?.linkedin_url ?? null} aria-label="linkedin">
