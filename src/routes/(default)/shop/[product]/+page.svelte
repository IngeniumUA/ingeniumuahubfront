<script lang="ts">
  ...
  async function copySharelink() {
    if (!navigator.clipboard) return; // Doesn't work on all browsers

    let baseLink = data.shop.derived_type.display.follow_through_link
    if (!baseLink.startsWith('https')) {
      baseLink = encodeURI(`https://ingeniumua.be${baseLink}`)
    }
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <section class="col-span-1 md:col-span-2">
      ...
      <div class="flex flex-row items-center justify-end mb-4">
        ...
        {#if ((data.shop.item.item_metadata.social_media_configuration?.linkedin_url ?? null) !== null)}
          <a href={data.shop.item.item_metadata.social_media_configuration?.linkedin_url ?? null} aria-label="linkedin">
        ...
        <button onclick={copySharelink} aria-label="share">
          <svg fill="#1f2980" width="24px" height="24px" viewBox="0 0 24 24" id="share" data-name="Line Color" xmlns="http://www.w3.org/2000/svg" class="icon line-color"><polyline id="secondary" points="8 6 12 2 16 6" style="fill: none; stroke: rgb(31,41,128); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></polyline><line id="secondary-2" data-name="secondary" x1="12" y1="2" x2="12" y2="15" style="fill: none; stroke: rgb(31,41,128); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></line><path id="primary" d="M16,10h2a1,1,0,0,1,1,1v9a1,1,0,0,1-1,1H6a1,1,0,0,1-1-1V11a1,1,0,0,1,1-1H8" style="fill: none; stroke: rgb(31,41,128); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></path></svg>
        </button>
      </div>
            ...
            <li class="product-group">
              ...
              <ul class="products" style:border-color={ primaryColor }>
                {#each group.products as product }
                  <li>
                    <ProductItemSelector product={product} item={data.shop.item} />
                  </li>
                {/each}
              </ul>
            </li>
      ...
      <div class="cart-button-container">
        <a href="/shop/cart" class="button button-primary"
           use:track={{ name: 'cart:view_cart', data: {
                item_name: data.shop.item.name, item_id: data.shop.item.id,
              } }}
