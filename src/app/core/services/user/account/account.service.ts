...
export class AccountService {
  ...
  public getAccount(): Observable<HubAccountData> {
    return this.httpClient.get<HubAccountData>(apiEnviroment.apiUrl.apiUrl + "user/account/")
  }

  // Extra Account Details
  public getAccountDetails(details: HubUserPersonalDetailsI): Observable<HubUserPersonalDetailsI> {
    return this.httpClient.post<HubUserPersonalDetailsI>(apiEnviroment.apiUrl.apiUrl + "user/account/personal", details)
  }
  ...
  public linkCard(card_uuid: string): Observable<HubCardI> {
    return this.httpClient.post<HubCardI>(apiEnviroment.apiUrl.apiUrl + "item/card/link/" + card_uuid, {})
  }

  public getTransactions(): Observable<CheckoutI[]> {
    return this.httpClient.get<CheckoutI[]>(apiEnviroment.apiUrl.apiUrl + "user/account/transactions")
  }
}
