...
export class ScanPage implements OnInit{
  ...
  constructor(private navCtrl: NavController,
    ...
    this.platform.backButton.subscribeWithPriority(10, () => {
      if (pageTree[pageTree.length-2] === 'login' || !pageTree[pageTree.length-2].includes("tabs_attendance") || !(pageTree[pageTree.length-2] === "result_attendance") || !(pageTree[pageTree.length-2] === "blueprints_attendance")) {
        this.ReturnToHome()
